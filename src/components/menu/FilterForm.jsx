    ...
    return (
        <Filters>
            ...
            <Box sx={{ width: "100%", display: "flex", justifyContent: "center", mt: 3 }}>
                <Button  sx={{ border: "3px solid #B71C1C", background: "#B71C1C", fontWeight: "300" , color: "#fff", borderRadius: "5px", width: "12rem", marginTop: "1rem", display: "flex", flexDirection: i18n.language == "ar" && "row-reverse" }} onClick={() => window.location.href = `/ads`}>
