...
function Inspection() {
    ...
    const headerTextStyles = { color: "#B71C1C", fontWeight: "bolder", marginTop: "4rem", textAlign: "right", textAlign: i18n.language == "ar" ? "right" : "left", }
    const text = t("inspectionPage.headerSubText")
    const textStyles = { fontWeight: "bold", fontSize: "22px", textAlign: "right", textAlign: i18n.language == "ar" ? "right" : "left", }
