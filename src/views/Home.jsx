...
function Home({ data }) {
  ...
  return (
    <>
      <Main image={i18n.language == "ar" ? "red-bg3_ar" : "red-bg4"} showForm={true} showText={true} form={<FilterForm />} headerText={headertext} headerTextStyles={headerTextStyles} text={text} textStyles={textStyles} flexDirection={i18n.language == "ar" ? "row-reverse" : "row"} />
